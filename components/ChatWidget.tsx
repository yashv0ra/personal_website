            ...
            <div className="flex flex-wrap gap-2 px-4 pb-3">
              {quickReplies.map((question) => (
                <button
                  ...
                  className="rounded-full border border-[var(--card-border)] bg-white/80 px-3 py-1 text-[0.65rem] uppercase tracking-[0.2em] text-[var(--accent-charcoal)] hover:bg-[var(--accent-orange)]/20"
                >
                  {question}
                </button>
              ))}
